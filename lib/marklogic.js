 ...
 */
MarkLogicClient.prototype.createCollection = function createClient() {
...
module.exports = {
     ...
     * or legacy slice(pageStart, pageLength) where pageStart is one-based. The
     * default is "legacy" at present but will become "array" in the next major
     * release.
     * @function
